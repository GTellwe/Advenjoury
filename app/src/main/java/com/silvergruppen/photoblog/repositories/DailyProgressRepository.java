...
public class DailyProgressRepository {
    ...
    public void updateDailyProgress(String userId, final MutableLiveData<DailyProgress> dailyProgress, int position, String done, String day){
        ...
        final ArrayList<Achievement> tmpList = dailyProgress.getValue().getDailyAchievementsList();
        for(int i =0; i<tmpList.size(); i++){

            Log.d("first" +tmpList.get(i).isDone(),"\n \n \n");
        }
        ...
        Log.d("update data "+done+" "+position," \n \n \n \n");
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        for(int i =0; i<tmpList.size(); i++){
                            ...
                            Log.d("second" +tmpList.get(i).isDone(),"\n \n \n");
                        }
...
/*
                        ArrayList<Boolean> achDoneList = new ArrayList<>();
                        for(int i = 0; i<8;i++)
                            achDoneList.add(dailyProgress.getValue().getDailyAchievementsList().get(i).isDone());
                        Log.d("sucessful update \n \n \n",achDoneList.get(1).toString());
  */                      //dailyProgress.setValue(new DailyProgress(achDoneList));
