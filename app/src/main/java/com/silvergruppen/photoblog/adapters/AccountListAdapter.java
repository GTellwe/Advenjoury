...
import com.silvergruppen.photoblog.holders.AccountListViewHolder;
...
public class AccountListAdapter extends ArrayAdapter<Achievement> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        AccountListViewHolder holder = null;
        ...
        if (convertView == null) {
            ...
            ConstraintLayout textViewWrap = (ConstraintLayout) convertView
                    .findViewById(R.id.account_list_view_layout);
            TextView text = (TextView) convertView.findViewById(R.id.achievement_name_text_view);
/*
...
*/
            holder = new AccountListViewHolder(textViewWrap, text, context);
...
/*
            ...
            holder = (AccountListViewHolder) convertView.getTag();
